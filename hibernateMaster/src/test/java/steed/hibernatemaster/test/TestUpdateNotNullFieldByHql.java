...
public class TestUpdateNotNullFieldByHql extends SteedTest{
...
//		student.updateNotNullFieldByHql(null, true, "clazz.id");
	...
	@Test
	public void testUpdateNotNullFieldByHql4() {
		Clazz clazz = prepareClazz();
		...
		school.setName(clazz.getSchool().getName());
		clazz.setSchool(school);
		clazz.updateNotNullFieldByHql("school.name");
